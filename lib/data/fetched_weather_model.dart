class FetchedWeatherModel {
  dynamic cod;
  dynamic message;
  City city;
  List<ListModel> list;

  FetchedWeatherModel({this.cod, this.message, this.city, this.list});

  factory FetchedWeatherModel.fromJson(Map<String, dynamic> json) {
    var tempList = json['list'] as List;
    List<ListModel> willReturnList =
        tempList.map((e) => ListModel.fromJson(e)).toList();
    return FetchedWeatherModel(
        cod: json['cod'],
